...
* src/finance_reader - модуль, реализовывающий считывание финансовых операций из CSV- и XLSX-файлов. Файлы находятся в папке data
...
Он предоставляет интерактивное меню для работы с банковскими транзакциями:

Выбор источника данных:

JSON — файл с операциями (operations.json)

CSV — файл с операциями (transactions.csv)

XLSX — файл с операциями (transactions_excel.xlsx)
...
Поиск по ключевым словам в описании операции

Вывод итогового списка транзакций в читаемом виде с маскировкой номеров карт и счетов
