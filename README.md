...
* src/external_api - модуль, содержащий функцию чтения JSON файла
* src/utils.py - модуль, содержащий функцию, которая принимает на вход транзакцию и возвращает сумму транзакции 
в рублях. Если транзакция была в USD или EUR , происходит обращение к внешнему API для получения текущего курса валют и конвертации суммы операции в рубли. 
...
* data/ - папка, где хранится файл с данными о финансовых транзациях operations.json
## Установка
...
Пример запуска модуля src/external_api

``print(transaction_amount_in_rubles({"amount": 10, "currency": "USD"}))``
